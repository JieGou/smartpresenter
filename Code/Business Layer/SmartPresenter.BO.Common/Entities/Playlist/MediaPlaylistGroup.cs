...
{
    /// <summary>
    /// A class for a group of media items.
    /// </summary>
    public class MediaPlaylistGroup : IPlaylist<IPlaylist<Image>>
    {
        ...
        /// </summary>
        private ObservableCollection<IPlaylist<Image>> _items;
        ...
        /// </summary>
        public ObservableCollection<IPlaylist<Image>> Items
        {
            get { return _items; }
        }
        ...
        {
            Id = Guid.NewGuid();
            _items = new ObservableCollection<IPlaylist<Image>>();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            MediaPlaylistGroup playlistGroup = obj as MediaPlaylistGroup;
        ...
        public object Clone()
        {
            IPlaylist<IPlaylist<Image>> clonedPlaylistGroup = new MediaPlaylistGroup();
            ...
            try
            {
                using (var stream = new MemoryStream())
                {
                    ...
                    clonedPlaylistGroup = (IPlaylist<IPlaylist<Image>>)binaryFormatter.Deserialize(stream);
                }
            }
            catch (Exception ex)
            {
