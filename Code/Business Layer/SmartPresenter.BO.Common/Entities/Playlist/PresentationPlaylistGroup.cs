...
{
    /// <summary>
    /// Class for a Group of Playlists.
    /// </summary>
    public class PresentationPlaylistGroup : IPlaylist<IPlaylist<IPresentation>>
    {
        ...
        /// </summary>
        private ObservableCollection<IPlaylist<IPresentation>> _items;
        ...
        /// </summary>
        public PresentationPlaylistGroup()
        {
            Initialize();
        }
        ...
        /// </summary>
        public ObservableCollection<IPlaylist<IPresentation>> Items
        {
            get { return _items; }
        }
        ...
        {
            Id = Guid.NewGuid();
            _items = new ObservableCollection<IPlaylist<IPresentation>>();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            PresentationPlaylistGroup playlistGroup = obj as PresentationPlaylistGroup;
        ...
        {
            writer.WriteStartElement("PlaylistGroup");
            ...
            foreach (IPlaylist<IPlaylist<IPresentation>> playlist in Items)
            {
        ...
        public object Clone()
        {
            IPlaylist<IPlaylist<IPresentation>> clonedPlaylistGroup = new PresentationPlaylistGroup();
            ...
            try
            {
                using (var stream = new MemoryStream())
                {
                    ...
                    clonedPlaylistGroup = (IPlaylist<IPlaylist<IPresentation>>)binaryFormatter.Deserialize(stream);
                }
