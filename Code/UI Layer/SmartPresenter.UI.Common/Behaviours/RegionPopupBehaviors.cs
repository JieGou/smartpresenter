...
namespace SmartPresenter.UI.Common.Behaviors
{
    /// <summary>
    ...
    public static class RegionPopupBehaviors
    {
        ...
        private static bool IsInDesignMode(DependencyObject shape)
        {
            // Due to a known issue in Cider, GetIsInDesignMode attached property value is not enough to know if it's in design mode.
            return DesignerProperties.GetIsInDesignMode(shape) || Application.Current == null
