...
namespace SmartPresenter.UI.Common.DragDrop
{
    ...
    {
        // Finds the orientation of the panel of the FrameworkElement that contains the itemContainer passed as a parameter.
        ...
        public static void InsertItemInItemsControl(FrameworkElement itemsControl, object itemToInsert, int insertionIndex)
        {
        ...
        public static int RemoveItemFromItemsControl(FrameworkElement itemsControl, object itemToRemove)
        {
